# Generated by Django 3.2.7 on 2023-04-09 05:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(blank='(Select Country)', default='KE', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Guwahati', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='784001', max_length=180, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Manik Nagar', max_length=150, verbose_name='Street Address')),
                ...
                ('plot_aread', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Plot Area(m^2)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('photo', models.ImageField(blank=True, default='/interior.jpg', null=True, upload_to='')),
