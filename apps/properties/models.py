...
class Property(TimeStampUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="KE", blank="(Select Country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Guwahati")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=180, default="784001")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Manik Nagar")
    property_number = models.IntegerField(verbose_name=_("Property Number"), validators=[
                                          MinValueValidator(1)], default=122)
    price = models.DecimalField(verbose_name=_("Price"), max_digits=8, decimal_places=2, default=0.0)
    tax = models.DecimalField(verbose_name=_("Property Tax"), max_digits=6, decimal_places=2,
                              default=0.15, help_text="15% property tax charged")
    plot_aread = models.DecimalField(verbose_name=_("Plot Area(m^2)"), max_digits=8, decimal_places=2, default=0.0)
...
class PropertyViews(TimeStampUUIDModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Total views on Property"


class PropertyImage(TimeStampUUIDModel):
    photo = models.ImageField(default="/interior.jpg", null=True, blank=True)
